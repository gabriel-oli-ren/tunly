  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CustomScrollView(
      ...
      slivers: [
        ...
        SliverPadding(
          padding: const EdgeInsets.fromLTRB(18, 2, 18, 210),
          sliver: SliverList.list(
            children: [
              const Text(
                'Music that meets your moment.',
    ...
    return Column(
      ...
      children: [
        ...
        if (quickPicks.isNotEmpty) ...[
          ...
          const _SectionTitle('Made for this moment'),
        ...
        if (feed.trending.isNotEmpty) ...[
          ...
          _SectionTitle('Trending in ${feed.regionName}'),
          const SizedBox(height: 13),
          Row(
            children: [
              const Icon(
...
class _LoadError extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      ...
      children: [
        const Text(
          'The music catalog is taking a moment.',
